...
import { Headset, Ticket, Users, UserCog, FileText, BarChart3, LogOut, Bell, Search, ChevronDown } from 'lucide-react';
import { useAuth } from '../context/AuthContext';

const navItems = [
  { label: 'Tickets', path: '/admin', icon: Ticket },
  { label: 'Clients', path: '/admin/clients', icon: Users },
  { label: 'Engineers', path: '/admin/engineers', icon: UserCog },
...
const AdminLayout = () => {
  ...
  // Controls whether each dropdown is currently visible
  ...
  return (
    <div className="flex min-h-screen bg-nexcanvas">
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center relative">
              ...
              {notifOpen && (
                <div className="absolute right-0 top-8 w-72 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                  <div className="px-4 py-3 border-b border-gray-100">
                    <p className="text-sm font-medium text-nextext">
                      Notifications
                    </p>
                  </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-xs font-medium text-nextext leading-none">
                    {user?.name}
                  </p>
                  <p className="text-[10px] text-gray-400 leading-none mt-0.5 capitalize">
                    {user?.role}
                  </p>
                </div>
              ...
              {profileOpen && (
                <div className="absolute right-0 top-10 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                  <div className="px-4 py-3 border-b border-gray-100">
                    ...
                    <span className="inline-block mt-1.5 text-[10px] px-2 py-0.5 rounded-full bg-nexaccent/10 text-nexaccent font-medium capitalize">
                      {user?.role}
                    </span>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2.5 text-sm text-red-600 flex items-center gap-2"
                  >
                    <LogOut size={14} />
                    Logout
                  </button>
